 ...
 * @author flora
 */
public class GameStepThree extends javax.swing.JFrame implements ActionListener {
...
//        countryN.addActionListener(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameStepThree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameStepThree().setVisible(true);
            }
        });
    }
