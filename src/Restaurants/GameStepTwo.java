 ...
 * @author flora
 */
public class GameStepTwo extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == nextButton) {
            JOptionPane.showMessageDialog(null, "Sorry! There is more level!");
//            this.dispose();
//            GameStepThree ob = new GameStepThree();
//            ob.setVisible(true);
        }
        ...
        if(t==5){
            ...
            int answer = JOptionPane.showConfirmDialog(null, "Good Job!!\nYou found all the words!\n"
                    +"You got"+score+"points.Want to play next level?\n", "Confirm", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameStepTwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameStepTwo().setVisible(true);
            }
        });
    }
