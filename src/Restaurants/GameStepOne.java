 ...
 * @author flora
 */
public class GameStepOne extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == nextButton) {
            this.dispose();
            GameStepTwo ob = new GameStepTwo();
            ob.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameStepOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameStepOne().setVisible(true);
            }
        });
    }
